...
public class CustomPanCardConstraintValidator implements ConstraintValidator<CustomPanCard, String> {
     ...
     */
    @Override
    public void initialize(CustomPanCard constraintAnnotation) {
