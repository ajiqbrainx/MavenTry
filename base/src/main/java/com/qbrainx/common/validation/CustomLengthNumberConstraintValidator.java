...
public class CustomLengthNumberConstraintValidator implements ConstraintValidator<CustomLength, Number> {
     ...
     * {@link #isValid(Number, ConstraintValidatorContext)} calls.
